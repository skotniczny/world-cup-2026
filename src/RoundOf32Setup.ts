...
export const roundOf32Slots = new Map<number, { home: GroupSlot; away: Slot }>([
  ...
  [86, { home: { group: "J", position: 1 }, away: { group: "H", position: 2 } }],
  ...
  [88, { home: { group: "D", position: 2 }, away: { group: "G", position: 2 } }], // M87
  ...
  [87, { home: { group: "K", position: 1 }, away: { thirdPlaceIndex: 6, position: 3 } }], // M86
