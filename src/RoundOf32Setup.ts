...
export const roundOf32Slots = new Map<number, { home: GroupSlot; away: Slot }>([
  [74, { home: { group: "C", position: 1 }, away: { group: "F", position: 2 } }], // M76
  [76, { home: { group: "F", position: 1 }, away: { group: "C", position: 2 } }], // M75
  [83, { home: { group: "H", position: 1 }, away: { group: "J", position: 2 } }], // M84
  [87, { home: { group: "J", position: 1 }, away: { group: "H", position: 2 } }], // M86
  [73, { home: { group: "A", position: 2 }, away: { group: "B", position: 2 } }],
  [77, { home: { group: "E", position: 2 }, away: { group: "I", position: 2 } }], // M78
  [84, { home: { group: "K", position: 2 }, away: { group: "L", position: 2 } }], // M83
  [86, { home: { group: "D", position: 2 }, away: { group: "G", position: 2 } }], // M88
  [79, { home: { group: "A", position: 1 }, away: { thirdPlaceIndex: 0, position: 3 } }],
  [85, { home: { group: "B", position: 1 }, away: { thirdPlaceIndex: 1, position: 3 } }],
  [82, { home: { group: "D", position: 1 }, away: { thirdPlaceIndex: 2, position: 3 } }], // M81
  [75, { home: { group: "E", position: 1 }, away: { thirdPlaceIndex: 3, position: 3 } }], // M74
  [81, { home: { group: "G", position: 1 }, away: { thirdPlaceIndex: 4, position: 3 } }], // M82
  [78, { home: { group: "I", position: 1 }, away: { thirdPlaceIndex: 5, position: 3 } }], // M77
  [88, { home: { group: "K", position: 1 }, away: { thirdPlaceIndex: 6, position: 3 } }], // M87
